"""
Django settings for asjvajshgvcj_6 project.
...
ROOT_URLCONF = 'asjvajshgvcj_6.urls'
...
WSGI_APPLICATION = 'asjvajshgvcj_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asjvajshgvcj_6 API",
    "DESCRIPTION": "API documentation for asjvajshgvcj_6 App",
    "VERSION": "v1",
}
